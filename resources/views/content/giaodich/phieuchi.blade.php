        ...
        fetch(apiUrl)
            ...
            .then(data => {
                ...
                data.forEach(phieuchichitiet => {
                    ...
                    cell2.innerHTML = `<input style="width: 245px; text-align: center;" type="text" id="soTien" value="${parseFloat(phieuchichitiet.SoTien).toLocaleString('vi-VN', { style: 'currency', currency: 'VND' })}">`;
