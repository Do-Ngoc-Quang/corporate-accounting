    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 content-main" id="main-content-subform">
        ...
        <div class="row" id="section1">
            ...
            <div class="col-10">
                ...
                <div id="section1-2">
                    <button class="btnAddnew" style="margin: 7px 50px 0 20px; width: 20%;" type="button" onclick="resetAndSetupValue()" id="btnLamMoi">Làm mới phiếu chi</button>
                    <button class="btnAddnew" style="margin-top: 7px; width: 70%;" type="button" onclick="addNewPhieuChi()" id="btnTaoPhieuChi">Tạo phiếu chi</button>
                </div>
            </div>
        </div>
