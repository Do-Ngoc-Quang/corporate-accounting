...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('phieu_xuat_hang_hoa_chi_tiets', function (Blueprint $table) {
            $table->id();
            $table->string('MaChungTu');
            $table->foreign('MaChungTu')->references('MaChungTu')->on('phieu_xuat_hang_hoas');
            $table->string('MaHang');
    ...
    {
        Schema::dropIfExists('phieu_xuat_hang_hoa_chi_tiets');
    }
};
